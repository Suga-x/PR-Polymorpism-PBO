...
public class Player {
    ...
    public boolean cariItem(String namaItem,String jenis) {
        for (Item objItem:arrItem) {
             if (namaItem.equals(objItem.getNama()) && jenis.equals(objItem.getJenis())) {
                 return (true);
            }
        }
    ...
    public void printPlayer() {
        ...
        System.out.println("Daya Serang : " +dayaSerang);
    }
...
//        }
    ...
    public void setDayaSerang(int dayaSerang) {
        this.dayaSerang = dayaSerang;
    }
}
